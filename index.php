            ...
            <?php foreach ($data['data']['items'] as $movie): ?>
              <div class="col-6 col-sm-6 col-md-3 col-lg-2">
                <div class="mb-4 card-movie">
                  <a href="/do-an-1-vlute/thong-tin.php?name=<?= htmlspecialchars($movie['name']) ?>&slug=<?= htmlspecialchars($movie['slug']) ?>">
                  ...
                  <div class="card-movie-body">
                    ...
                    <a href="/do-an-1-vlute/dang-xem.php?name=<?= htmlspecialchars($movie['name']) ?>&slug=<?= htmlspecialchars($movie['slug']) ?>" style="width: 100%;" class="btn btn-primary btn-sm">
