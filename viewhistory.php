            ...
            <div class="relative group">
              <div class="flex flex-col gap-2 group">
                ...
                <form method="POST" action="delete_movie.php" onsubmit="return confirm('Xóa phim khỏi lịch sử xem?');"
                  ...
                  <button type="submit"
                    class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br shadow-lg shadow-red-500/50 font-medium rounded-lg text-sm px-3 py-2 text-center"
                    title="Xóa phim">
